...
<html>
<head>
	<title>Employees Registration | Home</title>
...
<?php
/* this codes are used to delete specified field
	from database on click event from delete button
*/
...
<div class="table-contents" id="print" style="display: none;">
	<link rel="stylesheet" type="text/css" href="css/style.css">
