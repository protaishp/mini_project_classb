...
<html>
<head>
	<title>Employee Registration | Annual Report</title>
...
<div class="table-contents" id="print">
	...
	<table>
		<tr>
			<th colspan="10"><h2>Annual Report</h2></th>
		</tr>
		<tr>
			<th>ID Number</th>
			<th>First Name</th>
		...
		<?php
			$sql=$db->prepare("SELECT * FROM employee WHERE YEAR(dateInserted)= YEAR(now()) ORDER BY dateInserted DESC");
			$sql->execute();
			while($row= $sql->fetch()){
