...
<html>
<head>
	<title>Employee Registration | Daily Report</title>
...
<div class="table-contents" id="print">
	...
	<table>
		<tr>
			<th colspan="10"><h2>Daily Report</h2></th>
		</tr>
		<tr>
			<th>ID Number</th>
			<th>First Name</th>
		...
		<?php
			$sql=$db->prepare("SELECT * FROM employee WHERE DATE(dateInserted)= DATE(now()) ORDER BY dateInserted DESC");
			$sql->execute();
			while($row= $sql->fetch()){
